<!-- PORTFOLIO README HTML -->

<h1 align="center">🌐 Personal Portfolio Website</h1>

<p align="center">
A modern and responsive <b>portfolio website</b> showcasing my projects, skills, and experience as a Full-Stack Developer.
</p>
...
<h2>🚀 Live Demo</h2>
<p>
🔗 <a href="YOUR_PORTFOLIO_LINK">View Portfolio</a>
</p>
...
<ul>
  ...
  <li>⚡ Fast performance and optimized loading</li>
</ul>
...
<h3>Backend (if applicable):</h3>
<ul>
  <li>Node.js</li>
  <li>Express.js</li>
</ul>

<h3>Database (if applicable):</h3>
<ul>
  <li>MongoDB / SQL</li>
</ul>
...
<h2>📸 Screenshots</h2>
<p align="center">
  <img src="SCREENSHOT_1_URL" width="80%" />
</p>
...
<ul>
  ...
  <li>🔐 Add authentication (admin panel)</li>
  <li>⚡ Improve performance & SEO</li>
  <li>🎨 Add more animations and UI enhancements</li>
</ul>
...
<ul>
  ...
  <li>🔗 LinkedIn: <a href="YOUR_LINKEDIN_URL">Profile</a></li>
  <li>💻 GitHub: <a href="https://github.com/Apuravaanand">Apuravaanand</a></li>
</ul>
...
export default function Landing() {
    ...
    return (
        <div className="w-full min-h-screen overflow-x-hidden bg-[#fafafa] text-gray-900 font-sans">
            <Navbar />

            {/* Enhanced Background Glows */}
            <div className="fixed w-[500px] h-[500px] blur-[120px] rounded-full -top-20 -left-20 opacity-[0.15] bg-green-400 animate-pulse z-0" />
            <div className="fixed w-[500px] h-[500px] blur-[120px] rounded-full bottom-0 -right-20 opacity-[0.1] bg-blue-400 z-0" />

            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-16 grid md:grid-cols-2 gap-16 items-center min-h-[95vh] pt-24 pb-12">
